    ...
    <section style={styles.panel}>
      <div style={styles.header}>
        ...
        <div style={styles.actionButtons}>
          <button onClick={onRefresh} style={styles.btn} title="Yenile" type="button">
            ↻
          </button>
          <button onClick={onNew} style={styles.btn} title="Yeni danışan" type="button">
            ＋
          </button>
          <button
            onClick={() => setArama("")}
      ...
      <div style={styles.list}>
        {loading ? (
          <div style={styles.noResults}>
            <span style={styles.noResultsText}>Danışanlar yükleniyor...</span>
          </div>
            ...
            return (
              ...
              >
                <div style={styles.cardTop}>
                  <div style={styles.cardInfo}>
                    <span style={styles.cardName}>
                      {danisan.firstName} {danisan.lastName}
                    </span>
                ...
                <div style={styles.appointmentText}>
                  {formatAppointment(danisan.nextAppointment?.startsAt)}
                </div>
