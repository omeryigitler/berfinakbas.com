        ...
        <article className={styles.card}>
          ...
          <div className={styles.infoRows}>
            ...
            <div className={styles.infoRow}>
              ...
              <strong>{formatDashboardMoney(detailView.balance.amountMinor, detailView.balance.currency)}</strong>
            </div>
        ...
        <div className={styles.detailTop}>
          <div className={styles.toolbar}>
            <div className={styles.toolbarLeft}>
              <button className={styles.toolbarButton} disabled={!detail} onClick={onEdit} type="button"><SalesHubIcon name="edit" size={13} /> Düzenle</button>
              <button className={styles.toolbarButton} disabled={!detail} onClick={onNewAppointment} type="button"><SalesHubIcon name="plus" size={13} /> Yeni</button>
              <button className={styles.toolbarButton} disabled={!detail || submitting} onClick={onDeactivate} type="button"><SalesHubIcon name="trash" size={13} /> Sil</button>
              <button className={styles.toolbarButton} onClick={onRefresh} type="button"><SalesHubIcon name="refresh" size={13} /> Yenile</button>
              <button className={styles.toolbarButton} disabled={!detail} onClick={onNewPlan} type="button"><SalesHubIcon name="workflow" size={13} /> Plan Tanımla</button>
              <button className={styles.toolbarButton} disabled={!detail} onClick={onPrint} type="button"><SalesHubIcon name="file-down" size={13} /> To PDF</button>
              <button className={styles.toolbarButton} disabled={!detail} onClick={onNewPayment} type="button"><SalesHubIcon name="credit-card" size={13} /> Ödeme Al</button>
              ...
              <button className={styles.toolbarButton} disabled={!detail} onClick={onNewNote} title="Operasyonel not ekle" type="button"><SalesHubIcon name="more" size={14} /></button>
            </div>
            <button className={styles.backButton} onClick={onBack} type="button"><SalesHubIcon name="arrow-left" size={13} /> Geri Dön</button>
          </div>
