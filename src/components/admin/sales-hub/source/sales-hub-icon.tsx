...
export function SalesHubIcon({ name, size = 17 }: { name: SalesHubIconName; size?: number }) {
  ...
  const paths: Record<SalesHubIconName, ReactNode> = {
    ...
    'arrow-right': <><path d="M9 18l6-6-6-6"/><path d="M5 12h10"/></>,
    ...
    'credit-card': <><rect height="15" rx="2" width="19" x="2.5" y="5"/><path d="M2.5 10h19M6 15h4"/></>,
    ...
    'file-down': <><path d="M6 2h8l4 4v16H6z"/><path d="M14 2v5h5M12 11v7m-3-3l3 3 3-3"/></>,
    ...
    lock: <><rect height="10" rx="2" width="14" x="5" y="11"/><path d="M8 11V7a4 4 0 018 0v4"/></>,
    mail: <><rect height="14" rx="2" width="18" x="3" y="5"/><path d="M3 7l9 6 9-6"/></>,
    message: <path d="M4 5h16v12H8l-4 4z"/>,
    more: <><circle cx="5" cy="12" fill="currentColor" r="1" stroke="none"/><circle cx="12" cy="12" fill="currentColor" r="1" stroke="none"/><circle cx="19" cy="12" fill="currentColor" r="1" stroke="none"/></>,
    phone: <path d="M22 16.9v3a2 2 0 01-2.2 2 19.8 19.8 0 01-8.6-3.1 19.5 19.5 0 01-6-6A19.8 19.8 0 012.1 4.2 2 2 0 014.1 2h3a2 2 0 012 1.7c.1 1 .4 2 .7 2.8a2 2 0 01-.5 2.1L8.1 9.9a16 16 0 006 6l1.3-1.2a2 2 0 012.1-.5c.9.3 1.8.6 2.8.7A2 2 0 0122 16.9z"/>,
    ...
    workflow: <><circle cx="6" cy="6" r="2"/><circle cx="18" cy="6" r="2"/><circle cx="12" cy="18" r="2"/><path d="M8 6h8M7 8l4 8m6-8l-4 8"/></>,
