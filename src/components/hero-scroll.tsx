  ...
  return (
    <section className="scrollHero" ref={heroRef} aria-labelledby="hero-scroll-title">
      ...
      <div className="scrollHeroSticky">
        <div className="scrollHeroRoom" aria-hidden="true" style={{ backgroundImage: `url(${OFFICE_IMAGE})` }} />
        ...
        <div className="scrollHeroStage">
          <div className="scrollHeroPortrait"><img src={BERFIN_IMAGE} alt="Berfin Akbaş, Dil ve Konuşma Terapisti" draggable="false" /></div>
